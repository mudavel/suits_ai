...
6. **Copiloto de Negociação & Alçada:** Simulador em tempo real (Piso $\rightarrow$ Alvo $\rightarrow$ Teto) que avalia contrapropostas do autor contra a alçada do banco.
