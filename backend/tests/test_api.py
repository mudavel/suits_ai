...
from backend.dependencies import get_analysis_service, get_monitoring_service
from backend.main import create_app
from backend.schemas import AnalyzeResponse, MonitoringOverviewResponse, PolicyResult
...
def test_swagger_and_openapi_publish_all_phase_one_contracts(client):
    ...
    saved = Path(__file__).resolve().parents[1] / "openapi.json"
