...
from backend.schemas import CaseDetail
from backend.services.contracts import AnalysisService, CaseService, MonitoringService
from backend.services.mocks import (
    MockAnalysisService,
    MockCaseService,
