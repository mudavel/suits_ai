...
Em cerca de um terço dos processos que o Banco Unicamp recebe mensalmente, o autor alega não reconhecer a contratação de um empréstimo. Diante disso, o Banco precisa decidir se irá se defender no judiciário ou propor um acordo. Dessa forma, necessita de uma boa política de acordos, garantindo sua efetividade e que ela tenha boa aderência pelos advogados. 
...
| 1 | **Regra de Decisão** |  |
| 2 | **Sugestão de valor** |  |
| 3 | **Acesso à recomendação** |  |
| 4 | **Monitoramento de aderência** |  |
| 5 | **Monitoramento de efetividade** | |
---
